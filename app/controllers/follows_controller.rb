class FollowsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @follow.save
        format.html { redirect_to params[:redir_back] ? :back : @follow, notice: 'Follow was successfully created.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to params[:redir_back] ? :back : follows_url }
      format.json { head :ok }
    end
  end
end
